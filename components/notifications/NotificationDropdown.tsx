...
// COMPLETELY FIXED - No nested buttons!
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className={`font-bold flex items-center gap-2 ${darkMode ? "text-orange-100" : "text-orange-900"}`}>
                Notifications
              ...
              {notifications.map((notif) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left transition-opacity p-4 hover:opacity-80 active:opacity-60 ${
